...
wd = PATH_TO_ADA + "ada/geometry/airfoil_scraping/raw_airfoil_files/wind_turbines"
...
for fl in filteredFiles:
    ...
    plt.savefig(wd + '/plots/' + fl[0:-4] + '.png')
    afl.write2file(wd + os.sep + fl[0:-4] + '.dat')
    plt.close()
    ...
    if datfile not in list(du_corrections.values()):
        if 'afl-du-family' in datfile:
            if datfile in list(du_corrections.keys()):
                afl.write2file(PATH_TO_ADA + "ada/geometry/airfoil_files/"+du_corrections[datfile])
        elif 'riso-b' in datfile:
            afl.write2file(PATH_TO_ADA + "ada/geometry/airfoil_files/riso-b-%d.dat"%(int(100*afl.tau)))
        elif 'riso-p' in datfile:
            afl.write2file(PATH_TO_ADA + "ada/geometry/airfoil_files/riso-p-%d.dat"%(int(100*afl.tau)))
        else:
            afl.write2file(PATH_TO_ADA + "ada/geometry/airfoil_files/"+datfile)

...
# from corsair.core.pint_custom.unit import _Unit
...
# f.close()
    ...
    def upperCoefficients(self,val):
        ...
        if isinstance(val, (units.Quantity,pint.Quantity)):
            self.setterFunction(kwd, val.magnitude*units.dimensionless, 'dimensionless',None)
        else:
